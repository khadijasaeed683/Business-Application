...
void viewCollection(int totalProducts, string userPass[], int userCount, string productId[], string productName[], string price[]);
void placeOrder(string productId[], string productName[], string price[]);
void customerReview(string Review[], int reviewNo, int &r);
...
void addProduct(int &totalProducts, string productId[], string productName[], string price[]);
        ...
        else if (choice == "2") // signIn
        {
            ...
            if (j == "custome0r" || j == "customer" || j == "Customer" || j == "CUSTOMER")
            {
                while (j == "1")
                {
                    ...
                    {
                        customerReview(Review, reviewNo, r);
                    }
                    else if (cusChoice == "4")
                    {
                    ...
                    {
                        cout << "     THE OPTION YOU ENTERED IS NOT AVAILABLE\n       press any key to continue";
                        getch();
                    }
                }
            }
            ...
            else if (j == "Admin" || j == "admin")
            {
                ...
                if (ownerCheck(inCode, vCode))
                {
                    ...
                    while (true)
                    {
                        ...
                        {
                            addProduct(totalProducts, productId, productName, price);
                            writeProductData(productId, productName, price, totalProducts);
                        }
...
string getName()        //takes user input for name, stores it in a string and return it
{
    string name;
...
string displayWorkerMenu()
{
    ...
    cout << "\t~~~~~~~~~~~~~~~~~~~~\n\n\n";
    string workerChoice;
    cout << "Enter:      1 Delete Product       2 to view Collection    3 to view Customers Detail    0 to go back ";
    cin >> workerChoice;
    return workerChoice;
}
void cusDetail(string userName[], string userPass[], string role[], int userCount)
...
string displayAdminMenu() // gives different options to admin to access different functionalities
{
    ...
    cout << "5 to change admin verification code  " << endl;
    cout << "7 to add product  " << endl;
...
void customerReview(string Review[], int reviewNo, int &r) // takes review from customer and saves in an array of customer reviews(Review())
{
    cout << "Enter your review: ";

    getline(cin >> ws, Review[r]);
    r++;
...
void addProduct(int &totalProducts, string productId[], string productName[], string price[])
{
    ...
    cout << "\n\ttotal no of products is: " << totalProducts;
    cout << "\n\n     \t\tPress any key to continue...";
    getch();
}
...
void workerDetailHeader()
{
    cout << "      __   __        ___  __   __      __   ___ ___             " << endl;
